...
```
spark-master:
  image: bde2020/spark-master:2.2.0-hadoop2.8.1
...
spark-worker-1:
  image: bde2020/spark-worker:2.2.0-hadoop2.8.1
...
To start a Spark master:
    ...
    docker run --name spark-master -h spark-master -e ENABLE_INIT_DAEMON=false -d bde2020/spark-master:2.2.0-hadoop2.8.1

### Spark Worker
To start a Spark worker:

    docker run --name spark-worker-1 --link spark-master:spark-master -e ENABLE_INIT_DAEMON=false -d bde2020/spark-worker:2.2.0-hadoop2.8.1
